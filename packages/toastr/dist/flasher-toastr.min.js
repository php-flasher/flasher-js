...
=======
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?module.exports=e(require("@flasher/flasher"),require("jquery")):"function"==typeof define&&define.amd?define(["@flasher/flasher","jquery"],e):((t="undefined"!=typeof globalThis?globalThis:t||self).flasher=t.flasher||{},t.flasher.toastr=e(t.flasher,t.jQuery))}(this,(function(t,e){"use strict";function o(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var i={exports:{}};!function(t){var o;o=function(t){return function(){var e,o,i,a=0,s="error",n="info",r="success",c="warning",d={clear:function(o,i){var a=u();e||l(a),p(o,a,i)||function(o){for(var i=e.children(),a=i.length-1;a>=0;a--)p(t(i[a]),o)}(a)},remove:function(o){var i=u();e||l(i),o&&0===t(":focus",o).length?h(o):e.children().length&&e.remove()},error:function(t,e,o){return g({type:s,iconClass:u().iconClasses.error,message:t,optionsOverride:o,title:e})},getContainer:l,info:function(t,e,o){return g({type:n,iconClass:u().iconClasses.info,message:t,optionsOverride:o,title:e})},options:{},subscribe:function(t){o=t},success:function(t,e,o){return g({type:r,iconClass:u().iconClasses.success,message:t,optionsOverride:o,title:e})},version:"2.1.4",warning:function(t,e,o){return g({type:c,iconClass:u().iconClasses.warning,message:t,optionsOverride:o,title:e})}};return d;function l(o,i){return o||(o=u()),(e=t("#"+o.containerId)).length||i&&(e=function(o){return(e=t("<div/>").attr("id",o.containerId).addClass(o.positionClass)).appendTo(t(o.target)),e}(o)),e}function p(e,o,i){var a=!(!i||!i.force)&&i.force;return!(!e||!a&&0!==t(":focus",e).length||(e[o.hideMethod]({duration:o.hideDuration,easing:o.hideEasing,complete:function(){h(e)}}),0))}function A(t){o&&o(t)}function g(o){var s=u(),n=o.iconClass||s.iconClass;if(void 0!==o.optionsOverride&&(s=t.extend(s,o.optionsOverride),n=o.optionsOverride.iconClass||n),!function(t,e){if(t.preventDuplicates){if(e.message===i)return!0;i=e.message}return!1}(s,o)){a++,e=l(s,!0);var r=null,c=t("<div/>"),d=t("<div/>"),p=t("<div/>"),g=t("<div/>"),f=t(s.closeHtml),m={intervalId:null,hideEta:null,maxHideTime:null},x={toastId:a,state:"visible",startTime:new Date,options:s,map:o};return o.iconClass&&c.addClass(s.toastClass).addClass(n),function(){if(o.title){var t=o.title;s.escapeHtml&&(t=b(o.title)),d.append(t).addClass(s.titleClass),c.append(d)}}(),function(){if(o.message){var t=o.message;s.escapeHtml&&(t=b(o.message)),p.append(t).addClass(s.messageClass),c.append(p)}}(),s.closeButton&&(f.addClass(s.closeClass).attr("role","button"),c.prepend(f)),s.progressBar&&(g.addClass(s.progressClass),c.prepend(g)),s.rtl&&c.addClass("rtl"),s.newestOnTop?e.prepend(c):e.append(c),function(){var t="";switch(o.iconClass){case"toast-success":case"toast-info":t="polite";break;default:t="assertive"}c.attr("aria-live",t)}(),c.hide(),c[s.showMethod]({duration:s.showDuration,easing:s.showEasing,complete:s.onShown}),s.timeOut>0&&(r=setTimeout(w,s.timeOut),m.maxHideTime=parseFloat(s.timeOut),m.hideEta=(new Date).getTime()+m.maxHideTime,s.progressBar&&(m.intervalId=setInterval(y,10))),s.closeOnHover&&c.hover(C,v),!s.onclick&&s.tapToDismiss&&c.click(w),s.closeButton&&f&&f.click((function(t){t.stopPropagation?t.stopPropagation():void 0!==t.cancelBubble&&!0!==t.cancelBubble&&(t.cancelBubble=!0),s.onCloseClick&&s.onCloseClick(t),w(!0)})),s.onclick&&c.click((function(t){s.onclick(t),w()})),A(x),s.debug&&console&&console.log(x),c}function b(t){return null==t&&(t=""),t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function w(e){var o=e&&!1!==s.closeMethod?s.closeMethod:s.hideMethod,i=e&&!1!==s.closeDuration?s.closeDuration:s.hideDuration,a=e&&!1!==s.closeEasing?s.closeEasing:s.hideEasing;if(!t(":focus",c).length||e)return clearTimeout(m.intervalId),c[o]({duration:i,easing:a,complete:function(){h(c),clearTimeout(r),s.onHidden&&"hidden"!==x.state&&s.onHidden(),x.state="hidden",x.endTime=new Date,A(x)}})}function v(){(s.timeOut>0||s.extendedTimeOut>0)&&(r=setTimeout(w,s.extendedTimeOut),m.maxHideTime=parseFloat(s.extendedTimeOut),m.hideEta=(new Date).getTime()+m.maxHideTime)}function C(){clearTimeout(r),m.hideEta=0,c.stop(!0,!0)[s.showMethod]({duration:s.showDuration,easing:s.showEasing})}function y(){var t=(m.hideEta-(new Date).getTime())/m.maxHideTime*100;g.width(t+"%")}}function u(){return t.extend({},{tapToDismiss:!0,toastClass:"toast",containerId:"toast-container",debug:!1,showMethod:"fadeIn",showDuration:300,showEasing:"swing",onShown:void 0,hideMethod:"fadeOut",hideDuration:1e3,hideEasing:"swing",onHidden:void 0,closeMethod:!1,closeDuration:!1,closeEasing:!1,closeOnHover:!0,extendedTimeOut:1e3,iconClasses:{error:"toast-error",info:"toast-info",success:"toast-success",warning:"toast-warning"},iconClass:"toast-info",positionClass:"toast-top-right",timeOut:5e3,titleClass:"toast-title",messageClass:"toast-message",escapeHtml:!1,target:"body",closeHtml:'<button type="button">&times;</button>',closeClass:"toast-close-button",newestOnTop:!0,preventDuplicates:!1,progressBar:!1,progressClass:"toast-progress",rtl:!1},d.options)}function h(t){e||(e=l()),t.is(":visible")||(t.remove(),t=null,0===e.children().length&&(e.remove(),i=void 0))}}()},t.exports?t.exports=o(e):window.toastr=o(window.jQuery)}(i);var a=o(i.exports),s=[],n=[];!function(t,e){if(t&&"undefined"!=typeof document){var o,i=!0===e.prepend?"prepend":"append",a=!0===e.singleTag,r="string"==typeof e.container?document.querySelector(e.container):document.getElementsByTagName("head")[0];if(a){var c=s.indexOf(r);-1===c&&(c=s.push(r)-1,n[c]={}),o=n[c]&&n[c][i]?n[c][i]:n[c][i]=d()}else o=d();65279===t.charCodeAt(0)&&(t=t.substring(1)),o.styleSheet?o.styleSheet.cssText+=t:o.appendChild(document.createTextNode(t))}function d(){var t=document.createElement("style");if(t.setAttribute("type","text/css"),e.attributes)for(var o=Object.keys(e.attributes),a=0;a<o.length;a++)t.setAttribute(o[a],e.attributes[o[a]]);var s="prepend"===i?"afterbegin":"beforeend";return r.insertAdjacentElement(s,t),t}}(".toast-title{font-weight:700}.toast-message{-ms-word-wrap:break-word;word-wrap:break-word}.toast-message a,.toast-message label{color:#fff}.toast-message a:hover{color:#ccc;text-decoration:none}.toast-close-button{color:#fff;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=80);filter:alpha(opacity=80);float:right;font-size:20px;font-weight:700;line-height:1;opacity:.8;position:relative;right:-.3em;-webkit-text-shadow:0 1px 0 #fff;text-shadow:0 1px 0 #fff;top:-.3em}.toast-close-button:focus,.toast-close-button:hover{color:#000;cursor:pointer;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=40);filter:alpha(opacity=40);opacity:.4;text-decoration:none}.rtl .toast-close-button{float:left;left:-.3em;right:.3em}button.toast-close-button{-webkit-appearance:none;background:0 0;border:0;cursor:pointer;padding:0}.toast-top-center{right:0;top:0;width:100%}.toast-bottom-center{bottom:0;right:0;width:100%}.toast-top-full-width{right:0;top:0;width:100%}.toast-bottom-full-width{bottom:0;right:0;width:100%}.toast-top-left{left:12px;top:12px}.toast-top-right{right:12px;top:12px}.toast-bottom-right{bottom:12px;right:12px}.toast-bottom-left{bottom:12px;left:12px}#toast-container{pointer-events:none;position:fixed;z-index:999999}#toast-container *{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}#toast-container>div{background-position:15px;background-repeat:no-repeat;-moz-border-radius:3px;-webkit-border-radius:3px;border-radius:3px;-moz-box-shadow:0 0 12px #999;-webkit-box-shadow:0 0 12px #999;box-shadow:0 0 12px #999;color:#fff;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=80);filter:alpha(opacity=80);margin:0 0 6px;opacity:.8;overflow:hidden;padding:15px 15px 15px 50px;pointer-events:auto;position:relative;width:300px}#toast-container>div.rtl{background-position:right 15px center;direction:rtl;padding:15px 50px 15px 15px}#toast-container>div:hover{-moz-box-shadow:0 0 12px #000;-webkit-box-shadow:0 0 12px #000;box-shadow:0 0 12px #000;cursor:pointer;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=100);filter:alpha(opacity=100);opacity:1}#toast-container>.toast-info{background-image:url(data:image/png;base64,)!important}#toast-container>.toast-error{background-image:url(data:image/png;base64,)!important}#toast-container>.toast-success{background-image:url(data:image/png;base64,)!important}#toast-container>.toast-warning{background-image:url(data:image/png;base64,)!important}#toast-container.toast-bottom-center>div,#toast-container.toast-top-center>div{margin-left:auto;margin-right:auto;width:300px}#toast-container.toast-bottom-full-width>div,#toast-container.toast-top-full-width>div{margin-left:auto;margin-right:auto;width:96%}.toast{background-color:#030303}.toast-success{background-color:#51a351}.toast-error{background-color:#bd362f}.toast-info{background-color:#2f96b4}.toast-warning{background-color:#f89406}.toast-progress{background-color:#000;bottom:0;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=40);filter:alpha(opacity=40);height:4px;left:0;opacity:.4;position:absolute}@media (max-width:240px){#toast-container>div{padding:8px 8px 8px 50px;width:11em}#toast-container>div.rtl{padding:8px 50px 8px 8px}#toast-container .toast-close-button{right:-.2em;top:-.2em}#toast-container .rtl .toast-close-button{left:-.2em;right:.2em}}@media (min-width:241px) and (max-width:480px){#toast-container>div{padding:8px 8px 8px 50px;width:18em}#toast-container>div.rtl{padding:8px 50px 8px 8px}#toast-container .toast-close-button{right:-.2em;top:-.2em}#toast-container .rtl .toast-close-button{left:-.2em;right:.2em}}@media (min-width:481px) and (max-width:768px){#toast-container>div{padding:15px 15px 15px 50px;width:25em}#toast-container>div.rtl{padding:15px 50px 15px 15px}}",{});const r=new class{success(t,e,o){this.flash("success",t,e,o)}info(t,e,o){this.flash("info",t,e,o)}warning(t,e,o){this.flash("warning",t,e,o)}error(t,e,o){this.flash("error",t,e,o)}flash(t,e,o,i){const a=this.createNotification(t,e,o,i);this.renderOptions({}),this.render({notification:a})}createNotification(t,e,o,i){if("object"==typeof t?(t=(i=t).type,e=i.message,o=i.title):"object"==typeof e?(e=(i=e).message,o=i.title):"object"==typeof o&&(o=(i=o).title),void 0===e)throw new Error("message option is required");return{type:t||"info",message:e,title:o,options:i}}render(t){const{notification:e}=t,{message:o,title:i,options:s}=e;let n=e.type||"info";a[n](o,i,s).parent().attr("data-turbo-cache","false")}renderOptions(t){a.options={timeOut:t.timeOut||5e3,progressBar:t.progressBar||5e3,...t}}};return t.addFactory("toastr",r),r}));
>>>>>>> 37c201a (Wip)
=======
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?module.exports=e(require("@flasher/flasher"),require("jquery")):"function"==typeof define&&define.amd?define(["@flasher/flasher","jquery"],e):((t="undefined"!=typeof globalThis?globalThis:t||self).flasher=t.flasher||{},t.flasher.toastr=e(t.flasher,t.jQuery))}(this,(function(t,e){"use strict";function o(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var i={exports:{}};!function(t){var o;o=function(t){return function(){var e,o,i,a=0,s="error",n="info",r="success",c="warning",d={clear:function(o,i){var a=u();e||l(a),p(o,a,i)||function(o){for(var i=e.children(),a=i.length-1;a>=0;a--)p(t(i[a]),o)}(a)},remove:function(o){var i=u();e||l(i),o&&0===t(":focus",o).length?h(o):e.children().length&&e.remove()},error:function(t,e,o){return g({type:s,iconClass:u().iconClasses.error,message:t,optionsOverride:o,title:e})},getContainer:l,info:function(t,e,o){return g({type:n,iconClass:u().iconClasses.info,message:t,optionsOverride:o,title:e})},options:{},subscribe:function(t){o=t},success:function(t,e,o){return g({type:r,iconClass:u().iconClasses.success,message:t,optionsOverride:o,title:e})},version:"2.1.4",warning:function(t,e,o){return g({type:c,iconClass:u().iconClasses.warning,message:t,optionsOverride:o,title:e})}};return d;function l(o,i){return o||(o=u()),(e=t("#"+o.containerId)).length||i&&(e=function(o){return(e=t("<div/>").attr("id",o.containerId).addClass(o.positionClass)).appendTo(t(o.target)),e}(o)),e}function p(e,o,i){var a=!(!i||!i.force)&&i.force;return!(!e||!a&&0!==t(":focus",e).length||(e[o.hideMethod]({duration:o.hideDuration,easing:o.hideEasing,complete:function(){h(e)}}),0))}function A(t){o&&o(t)}function g(o){var s=u(),n=o.iconClass||s.iconClass;if(void 0!==o.optionsOverride&&(s=t.extend(s,o.optionsOverride),n=o.optionsOverride.iconClass||n),!function(t,e){if(t.preventDuplicates){if(e.message===i)return!0;i=e.message}return!1}(s,o)){a++,e=l(s,!0);var r=null,c=t("<div/>"),d=t("<div/>"),p=t("<div/>"),g=t("<div/>"),f=t(s.closeHtml),m={intervalId:null,hideEta:null,maxHideTime:null},x={toastId:a,state:"visible",startTime:new Date,options:s,map:o};return o.iconClass&&c.addClass(s.toastClass).addClass(n),function(){if(o.title){var t=o.title;s.escapeHtml&&(t=b(o.title)),d.append(t).addClass(s.titleClass),c.append(d)}}(),function(){if(o.message){var t=o.message;s.escapeHtml&&(t=b(o.message)),p.append(t).addClass(s.messageClass),c.append(p)}}(),s.closeButton&&(f.addClass(s.closeClass).attr("role","button"),c.prepend(f)),s.progressBar&&(g.addClass(s.progressClass),c.prepend(g)),s.rtl&&c.addClass("rtl"),s.newestOnTop?e.prepend(c):e.append(c),function(){var t="";switch(o.iconClass){case"toast-success":case"toast-info":t="polite";break;default:t="assertive"}c.attr("aria-live",t)}(),c.hide(),c[s.showMethod]({duration:s.showDuration,easing:s.showEasing,complete:s.onShown}),s.timeOut>0&&(r=setTimeout(w,s.timeOut),m.maxHideTime=parseFloat(s.timeOut),m.hideEta=(new Date).getTime()+m.maxHideTime,s.progressBar&&(m.intervalId=setInterval(y,10))),s.closeOnHover&&c.hover(C,v),!s.onclick&&s.tapToDismiss&&c.click(w),s.closeButton&&f&&f.click((function(t){t.stopPropagation?t.stopPropagation():void 0!==t.cancelBubble&&!0!==t.cancelBubble&&(t.cancelBubble=!0),s.onCloseClick&&s.onCloseClick(t),w(!0)})),s.onclick&&c.click((function(t){s.onclick(t),w()})),A(x),s.debug&&console&&console.log(x),c}function b(t){return null==t&&(t=""),t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function w(e){var o=e&&!1!==s.closeMethod?s.closeMethod:s.hideMethod,i=e&&!1!==s.closeDuration?s.closeDuration:s.hideDuration,a=e&&!1!==s.closeEasing?s.closeEasing:s.hideEasing;if(!t(":focus",c).length||e)return clearTimeout(m.intervalId),c[o]({duration:i,easing:a,complete:function(){h(c),clearTimeout(r),s.onHidden&&"hidden"!==x.state&&s.onHidden(),x.state="hidden",x.endTime=new Date,A(x)}})}function v(){(s.timeOut>0||s.extendedTimeOut>0)&&(r=setTimeout(w,s.extendedTimeOut),m.maxHideTime=parseFloat(s.extendedTimeOut),m.hideEta=(new Date).getTime()+m.maxHideTime)}function C(){clearTimeout(r),m.hideEta=0,c.stop(!0,!0)[s.showMethod]({duration:s.showDuration,easing:s.showEasing})}function y(){var t=(m.hideEta-(new Date).getTime())/m.maxHideTime*100;g.width(t+"%")}}function u(){return t.extend({},{tapToDismiss:!0,toastClass:"toast",containerId:"toast-container",debug:!1,showMethod:"fadeIn",showDuration:300,showEasing:"swing",onShown:void 0,hideMethod:"fadeOut",hideDuration:1e3,hideEasing:"swing",onHidden:void 0,closeMethod:!1,closeDuration:!1,closeEasing:!1,closeOnHover:!0,extendedTimeOut:1e3,iconClasses:{error:"toast-error",info:"toast-info",success:"toast-success",warning:"toast-warning"},iconClass:"toast-info",positionClass:"toast-top-right",timeOut:5e3,titleClass:"toast-title",messageClass:"toast-message",escapeHtml:!1,target:"body",closeHtml:'<button type="button">&times;</button>',closeClass:"toast-close-button",newestOnTop:!0,preventDuplicates:!1,progressBar:!1,progressClass:"toast-progress",rtl:!1},d.options)}function h(t){e||(e=l()),t.is(":visible")||(t.remove(),t=null,0===e.children().length&&(e.remove(),i=void 0))}}()},t.exports?t.exports=o(e):window.toastr=o(window.jQuery)}(i);var a=o(i.exports),s=[],n=[];!function(t,e){if(t&&"undefined"!=typeof document){var o,i=!0===e.prepend?"prepend":"append",a=!0===e.singleTag,r="string"==typeof e.container?document.querySelector(e.container):document.getElementsByTagName("head")[0];if(a){var c=s.indexOf(r);-1===c&&(c=s.push(r)-1,n[c]={}),o=n[c]&&n[c][i]?n[c][i]:n[c][i]=d()}else o=d();65279===t.charCodeAt(0)&&(t=t.substring(1)),o.styleSheet?o.styleSheet.cssText+=t:o.appendChild(document.createTextNode(t))}function d(){var t=document.createElement("style");if(t.setAttribute("type","text/css"),e.attributes)for(var o=Object.keys(e.attributes),a=0;a<o.length;a++)t.setAttribute(o[a],e.attributes[o[a]]);var s="prepend"===i?"afterbegin":"beforeend";return r.insertAdjacentElement(s,t),t}}(".toast-title{font-weight:700}.toast-message{-ms-word-wrap:break-word;word-wrap:break-word}.toast-message a,.toast-message label{color:#fff}.toast-message a:hover{color:#ccc;text-decoration:none}.toast-close-button{color:#fff;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=80);filter:alpha(opacity=80);float:right;font-size:20px;font-weight:700;line-height:1;opacity:.8;position:relative;right:-.3em;-webkit-text-shadow:0 1px 0 #fff;text-shadow:0 1px 0 #fff;top:-.3em}.toast-close-button:focus,.toast-close-button:hover{color:#000;cursor:pointer;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=40);filter:alpha(opacity=40);opacity:.4;text-decoration:none}.rtl .toast-close-button{float:left;left:-.3em;right:.3em}button.toast-close-button{-webkit-appearance:none;background:0 0;border:0;cursor:pointer;padding:0}.toast-top-center{right:0;top:0;width:100%}.toast-bottom-center{bottom:0;right:0;width:100%}.toast-top-full-width{right:0;top:0;width:100%}.toast-bottom-full-width{bottom:0;right:0;width:100%}.toast-top-left{left:12px;top:12px}.toast-top-right{right:12px;top:12px}.toast-bottom-right{bottom:12px;right:12px}.toast-bottom-left{bottom:12px;left:12px}#toast-container{pointer-events:none;position:fixed;z-index:999999}#toast-container *{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}#toast-container>div{background-position:15px;background-repeat:no-repeat;-moz-border-radius:3px;-webkit-border-radius:3px;border-radius:3px;-moz-box-shadow:0 0 12px #999;-webkit-box-shadow:0 0 12px #999;box-shadow:0 0 12px #999;color:#fff;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=80);filter:alpha(opacity=80);margin:0 0 6px;opacity:.8;overflow:hidden;padding:15px 15px 15px 50px;pointer-events:auto;position:relative;width:300px}#toast-container>div.rtl{background-position:right 15px center;direction:rtl;padding:15px 50px 15px 15px}#toast-container>div:hover{-moz-box-shadow:0 0 12px #000;-webkit-box-shadow:0 0 12px #000;box-shadow:0 0 12px #000;cursor:pointer;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=100);filter:alpha(opacity=100);opacity:1}#toast-container>.toast-info{background-image:url(data:image/png;base64,)!important}#toast-container>.toast-error{background-image:url(data:image/png;base64,)!important}#toast-container>.toast-success{background-image:url(data:image/png;base64,)!important}#toast-container>.toast-warning{background-image:url(data:image/png;base64,)!important}#toast-container.toast-bottom-center>div,#toast-container.toast-top-center>div{margin-left:auto;margin-right:auto;width:300px}#toast-container.toast-bottom-full-width>div,#toast-container.toast-top-full-width>div{margin-left:auto;margin-right:auto;width:96%}.toast{background-color:#030303}.toast-success{background-color:#51a351}.toast-error{background-color:#bd362f}.toast-info{background-color:#2f96b4}.toast-warning{background-color:#f89406}.toast-progress{background-color:#000;bottom:0;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=40);filter:alpha(opacity=40);height:4px;left:0;opacity:.4;position:absolute}@media (max-width:240px){#toast-container>div{padding:8px 8px 8px 50px;width:11em}#toast-container>div.rtl{padding:8px 50px 8px 8px}#toast-container .toast-close-button{right:-.2em;top:-.2em}#toast-container .rtl .toast-close-button{left:-.2em;right:.2em}}@media (min-width:241px) and (max-width:480px){#toast-container>div{padding:8px 8px 8px 50px;width:18em}#toast-container>div.rtl{padding:8px 50px 8px 8px}#toast-container .toast-close-button{right:-.2em;top:-.2em}#toast-container .rtl .toast-close-button{left:-.2em;right:.2em}}@media (min-width:481px) and (max-width:768px){#toast-container>div{padding:15px 15px 15px 50px;width:25em}#toast-container>div.rtl{padding:15px 50px 15px 15px}}",{});const r=new class{success(t,e,o){this.flash("success",t,e,o)}info(t,e,o){this.flash("info",t,e,o)}warning(t,e,o){this.flash("warning",t,e,o)}error(t,e,o){this.flash("error",t,e,o)}flash(t,e,o,i){const a=this.createNotification(t,e,o,i);this.renderOptions({}),this.render({notification:a})}createNotification(t,e,o,i){if("object"==typeof t?(t=(i=t).type,e=i.message,o=i.title):"object"==typeof e?(e=(i=e).message,o=i.title):"object"==typeof o&&(o=(i=o).title),void 0===e)throw new Error("message option is required");return{type:t||"info",message:e,title:o,options:i}}render(t){const{notification:e}=t,{message:o,title:i,options:s}=e,n=e.type||"info";a[n](o,i,s).parent().attr("data-turbo-cache","false")}renderOptions(t){a.options={timeOut:t.timeOut||5e3,progressBar:t.progressBar||5e3,...t}}};return t.addFactory("toastr",r),r}));
>>>>>>> 697b1a2 (Wip)
