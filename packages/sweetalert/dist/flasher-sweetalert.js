...
`;
    ...
    class SweetAlertFactory {
        ...
        render(envelope) {
            ...
            options = Object.assign(Object.assign({}, options), { icon: ((options === null || options === void 0 ? void 0 : options.icon) || notification.type), text: ((options === null || options === void 0 ? void 0 : options.text) || notification.message) });
        ...
        renderOptions(options) {
            this.swalToastr = this.swalToastr || Swal.mixin(Object.assign({ timer: (options.timer || 5000), timerProgressBar: (options.timerProgressBar || true) }, options));
        ...
        renderQueue() {
            return __awaiter(this, void 0, void 0, function* () {
                for (let i = 0; i < this.queue.length; i++) {
                    yield this.render(this.queue[i]);
                }
            });
        }
    }
